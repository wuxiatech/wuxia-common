...
import cn.wuxia.common.spring.support.ValidationHandler;
...
public class FormModelMethodArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public final Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer,
        ...
        if (target != null) {
            ...
            validateIfApplicable(parameter,target);
    ...
    protected void validateIfApplicable( MethodParameter parameter,Object target) {
        Annotation[] annotations = parameter.getParameterAnnotations();
        for (Annotation annot : annotations) {
            if (annot.annotationType().getSimpleName().startsWith("Valid")) {
                validationHandler.doValidate(target);
            }
        }
    }
