...
public class SensitiveWordFilter {
    ...
    public static void main(String[] args) {
        ...
        Map sensitiveWordMap = filter.sensitiveWordMap;
        System.out.println("敏感词的数量：" + sensitiveWordMap.size());
        String string = "太多一个大批贪官w人的伤感情怀也许只局限于饲养基地 荧幕中的情节，主人公尝试着去用某种方式渐渐的很潇洒地释自杀指南怀那些自己经历的伤感。"
                + "然后法轮功 我们的扮演的角色就是跟随着主人公的喜红客联盟 怒哀乐而过于牵强的把自己的情感也附加于银幕情节中，然后感动就流泪，" + "助考网游精佑"
                + "难过就躺在某一个人的怀里尽情的阐述心扉或者手机卡复制器一个人一杯红酒一部电影在夜三级片 深人静的晚上，关上电话静静的发呆着。2233.ccwww.brans.pl人民报讯仁寿警方他媽的=>他*的他娘的代-办-证件南京办证原料为医用涤棉";
