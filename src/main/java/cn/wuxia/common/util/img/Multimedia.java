...
public abstract class Multimedia {
     ...
     * @throws ImgException 
     */
    public static void saveImage(File img, String dest, int width, int height) throws IOException, ImgException {
        ImageUtils.scale(img, new File(dest), width, height);
    }
     ...
     * @throws ImgException 
     */
    public static void saveImage(File img, String dest, int top, int left, int width, int height, int objWidth, int objHeight)
            throws IOException, ImgException {
        ImageUtils.crop(img, new File(dest), left, top, width, height, objWidth, objHeight);
    }
