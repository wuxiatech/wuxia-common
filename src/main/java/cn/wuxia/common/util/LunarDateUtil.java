...
public class LunarDateUtil {
    ...
    final static String simpleNumber[] = { "01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11", "12" };
    ...
    public String simple() {
        String simpleday = day < 10 ? "0" + day : "" + day;
        return year + simpleNumber[month - 1] + simpleday;
    }

    public static String mouthDay(Date date){
        Calendar today = Calendar.getInstance();
        today.setTime(date);
        LunarDateUtil lunar = new LunarDateUtil(today);
       return (lunar.leap ? "闰" : "") + chineseNumber[lunar.month - 1] + "月" + getChinaDayString(lunar.day);
    }
    ...
    public static void main(String[] args) throws ParseException {
        ...
        LunarDateUtil lunar = new LunarDateUtil(today);
        System.out.println("北京时间：" + chineseDateFormat.format(today.getTime()) + "　农历" + lunar.simple());
        System.out.println(new LunarDateUtil(Calendar.getInstance()).simple());
        System.out.println(DateUtil.stringToDate("20180216"));
        System.out.println(LunarDateUtil.mouthDay(DateUtil.stringToDate("2018-02-16")));
        System.out.println(StringUtil.substring(new LunarDateUtil(Calendar.getInstance()).simple(), 4, new LunarDateUtil(Calendar.getInstance()).simple().length()));
    }
}
